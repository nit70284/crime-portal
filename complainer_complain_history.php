...
<head>
    ...
    if(isset($_POST['s2']))
    {
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $result=mysqli_query("SELECT a_no FROM complaint where c_id='$cid'",$conn);
    ...
    $query="select a_no,c_id,type_crime,d_o_c,location from complaint where a_no='$a_no' order by c_id desc";
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Nitesh Crime Portal 2024</b></h4>
</div> 
